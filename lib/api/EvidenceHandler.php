...
class EvidenceHandler
{
    ...
    {
        $description = "List the evidences. The results will be an array where " .
            "the key is the term and the individual records will consist " .
            "(id, term).";
        $options = array(
            "id"          => "Return the evidence matching the internal id",
            "limit"       => "The maximum number of evidences to return",
            "limitoffset" => "The offset of the first evidence to return. " .
                             "It (requires \"limit\")",
            "name"        => "Return only the evidence(s) matching the term",
    ...
    public function listAction(
        ...
        foreach ( $arguments as $arg => $value ) {
            ...
            switch ( $arg ) {
                case "id":
                    $sqlCriteria[] = "evidence_id " . $sqlOperator . " " . $db->escape($value);
                    break;
                case "name":
