<?php
class ReporterconstructtriplestoreHandler implements iEditable
{
    private $db = null;
    // --------------------------------------------------------------------------------
    ...
    {
        return new ReporterconstructtriplestoreHandler;
    }
    ...
    public function loadAction(
        ...
        INNER JOIN ReporterConstruct rc ON ts.rc_id = rc.rc_id
