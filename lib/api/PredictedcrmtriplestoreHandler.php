<?php
class PredictedcrmtriplestoreHandler implements iEditable
{
    private $db = null;
    // --------------------------------------------------------------------------------
    ...
    {
        return new PredictedcrmtriplestoreHandler;
    }
    ...
    public function loadAction(
        ...
        INNER JOIN PredictedCRM pcrm ON ts.predicted_crm_id = pcrm.predicted_crm_id
...
SQL;
    ...
    public function saveAction(
        ...
        $predictedCrmTsHelper = PredictedCrmTsHelper::factory();
        $tsId = $predictedCrmTsHelper->create($data);
        $data["ts_id"] = $tsId;
