// -----------------------------------------------------------------------------------
// Combined combo box and grid of selected anatomical expression terms for reporter
// constructs.
// -----------------------------------------------------------------------------------
REDfly.component.curateRcAnatomicalExpressionTerms = Ext.extend(Ext.form.CompositeField, {
    anchor: '100%',
    ...
    constructor: function(config) {
        ...
        REDfly.component.curateRcAnatomicalExpressionTerms.superclass.constructor.call(this, config);
    },
    initComponent: function() {
                            ...
                            columns: [
                                {
                                    ...
                                    items: [{
                                        handler: function(grid, rowIndex) {
                                            var rctsPanelItem = new REDfly.component.rctsPanel({
                                            ...
                                            var rctsCrudWindow = new Ext.Window({
                                                // Ext.Window configs
                                                autoScroll: true,
                                                id: 'rctsCrudWindowId',
                                                layout: 'auto',
                                                ...
                                                modal: true,
                                                title: 'Reporter Construct Staging Data',
                                                width: 550,
                                                // REDfly configs
                                                rctsPanel: rctsPanelItem
                                            });
                                            rctsCrudWindow.show();
                                            rctsCrudWindow.getEl().setStyle('z-index','90000');
                                        },
        ...
        REDfly.component.curateRcAnatomicalExpressionTerms.superclass.initComponent.apply(this, arguments);
    },
    // --------------------------------------------------------------------------------
    ...
    setRcId: function(rcId) {
        this.rcId = rcId;
    }
});
// --------------------------------------------------------------------------------
// Grid of selected staging data for reporter constructs.
// --------------------------------------------------------------------------------
REDfly.component.curateRcStagingData = Ext.extend(Ext.form.CompositeField, {
    anchor: '100%',
    ...
    constructor: function(config) {
        ...
        REDfly.component.curateRcStagingData.superclass.constructor.call(this, config);
    },
    initComponent: function() {
        Ext.apply(this, {
            items: [
                        ...
                        columns: [
                            {
                                ...
                                items: [{
                                    handler: function(grid, rowIndex) {
                                        ...
                                        // The rcts panel needs to monitor the beforeshow event of the
                                        // window and load itself before being displayed.
                                        rctsCrudWindow.rctsPanel.mon(
                                            rctsCrudWindow,
                                            'beforeshow',
                                            function() {
                                                this.load(grid.getStore().getAt(rowIndex).get('ts_id'));
                                            },
                                            rctsCrudWindow.rctsPanel
                                        );
                                        rctsCrudWindow.show();
                                        rctsCrudWindow.getEl().setStyle('z-index', '90000');
                                    },
        ...
        REDfly.component.curateRcStagingData.superclass.initComponent.apply(this, arguments);
    },
    // --------------------------------------------------------------------------------
    // Add a record to the store of the component.
    // @param {Ext.data.Record} record The record to add.
